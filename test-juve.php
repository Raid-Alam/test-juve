<?php
/*
 * Plugin Name: Test juve call of post exerpt
 */
...
add_action( 'wp_juve_nopriv_get_latest_post', 'get_latest_published_post' );
add_action( 'wp_juve_get_latest_post', 'get_latest_published_post' );
